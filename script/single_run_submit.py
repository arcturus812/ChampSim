...
def main():
    ...
    for _, row in df.iterrows():
        # cmd = make_command(row["trace_file"], WARM_INST, SIM_INST, bin_suffix="_stall_dram", log_dir="all_dram_stall/nextline_spp_stream/C1_W20M_S100M", feed_path="") 
        cmd = make_command(row["trace_file"], WARM_INST, SIM_INST, bin_suffix="_stall_cxl", log_dir="all_cxl_stall/nextline_spp_stream/C1_W20M_S100M", feed_path="") 
